...
function RenderPlanet() {
  ...
  return (
    ...
    <PlanetInfoBox>
      <InfoButtonsBox>
        <OverviewBtn onClick={() => setCharacteristics("overview")}>
          Overview
        </OverviewBtn>
        <StructureBtn onClick={() => setCharacteristics("structure")}>
          Structure
        </StructureBtn>
        <Surface onClick={() => setCharacteristics("geology")}>Surface</Surface>
      </InfoButtonsBox>
      <RenderdInfoBox>
        <PlanetImg
          src={
